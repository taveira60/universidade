...
y1_star = solve(gradl_w_star == [0; 0; 0], y1)
...
% 11. Verificar os autovalores da Hessiana reduzida para classificar o ponto
disp('Autovalores da Hessiana Reduzida (se todos > 0, é mínimo local estrito):')
eig(H_reduzida)
...
%%
epsilon=0.000001;
Kmax=300;    % número máximo de iterações
gamma=1.e-12;
%% aplicar o algoritmo Método BFGS + estratégia skkiping + procura de Armijo com backtracking

[wopt,Fopt,output]=BFGS_Armijo(@F1withgrad,H0,w0,epsilon,Kmax,gamma)

%% gráfico das curvas de nível de F
% criar grelha de pontos
[w1,w2] = meshgrid(-2.5:0.01:2.5, -0.5:0.01:2);
vals_F = 100*(w2-w1.^2).^2+(1-w1).^2;
...
text(vals_w1(1)-0.2, vals_w2(1)+0.1,'w0')
text(vals_w1(end), vals_w2(end)+0.1,'w*')

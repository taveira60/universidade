...
model<-lm(nota~horas_estudo,data=estudo_notas)
summary(model)

#o HO reperesenta que nao existe uma regressao linear forte entre x e y H1 significa que existe.como rejeitamos h0 tem significancia,horas de estudo explicam variabilidade das notas.
#e)
confint(model) #default e 0.95 se naoo temos que meter lvl

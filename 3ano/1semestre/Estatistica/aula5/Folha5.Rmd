...
ggpairs(tux)
#b)
cor<-cor(tux,method = 'pearson')
#c)
#uma potecial colinearidade sera entao entre o boddy mass e entre o comprimento de barbatana , dizendo assim que podemos obsercar que pinguins mais gordos tens barbatanas maiores .



#coreelacoes negativas quanto  mais proximo de -1 e de 1 mais forte e a correlaçao!!!!!!!!!!!!!!
...
Res.:as duas que tem maior influencia no seu peso e a sua especie e o seu sexo, tambem podemos observar que o tamabnho do bico tamabem influencia o tamanho do pinguim
